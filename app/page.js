    ...
    <>
      <form className='w-11/12 container mx-auto mt-20 rounded-lg shadow-2xl p-3 md:p-10 md:w-1/2'>
        ...
        <div class="mb-6">
          ...
          <textarea type="text" name='desc' id="desc" placeholder='Add a description...' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={todo.desc} onChange={handleForm} required />
        </div>
